...
function generatePersonFrontendHTML($id) {
    ...
    while($personPost->have_posts()) {
        ...
        <div class="person_frontend_container">
            ...
            <div class="mo_person_modal modal fade" id="exampleModalCenter_<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <ul class="mo_person_social_media">
                    <li class="social_item_list mo_person_github_link">
                        <a target="_blank" class="social_link" href="<?php echo $person_github; ?>">
                    ...
                    <li class="social_item_list mo_person_linkedin_link">
                        <a target="_blank" class="social_link" href="<?php echo $person_linkedin; ?>">
                    ...
                    <li class="social_item_list mo_person_xing_link">
                        <a target="_blank" class="social_link" href="<?php echo $person_xing; ?>">
                    ...
                    <li class="social_item_list mo_person_facebook_link">
                        <a target="_blank" class="social_link" href="<?php echo $person_facebook; ?>">
